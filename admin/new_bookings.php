                        ...
                        foreach ($results as $row) { ?>
                          <tr>
                            ...
                            <td class=" text-center">
                              ...
                              <a href="#" class="edit_data2 btn btn-purple rounded" id="<?php echo ($row->ID); ?>"><i
                                  class="mdi mdi-pencil-box-outline " aria-hidden="true" title="Take action"></i></a>
                            </td>
                          </tr>
                          <?php
                          $cnt = $cnt + 1;
