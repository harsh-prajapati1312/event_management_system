      ...
      <li class="nav-item nav-profile dropdown">
        ...
        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
          <a class="dropdown-item" href="profile.php">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item" href="\event_project1\index.php">
  ...
  <div class="navbar-menu-wrapper d-flex align-items-stretch w-100">
    ...
    <ul class="navbar-nav navbar-nav-left">
        <li class="nav-item dropdown">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href="manage_dept.php">Dept</a>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link" href="manage_emp.php">Employee</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="review.php">feedback</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="manage_gallery.php">Gallery</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="manage_venue.php">venue</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="payview.php">payment</a>
          </li>
            <li class="nav-item dropdown">
