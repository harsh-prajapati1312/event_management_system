            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">payment View</h5>
                </div>
            ...
            <table class="table align-items-center table-flush table-hover" id="dataTableHover">
              <thead>
                <tr>
                 ...
                 <th class="d-none d-sm-table-cell">payment id</th>
                ...
                foreach($results as $row)
                  {               ?>
                    <tr>
                      ...
                      <td class="font-w600"><?php  echo htmlentities($row->payment_status);?></td>
                      <td class="font-w600"><?php  echo htmlentities($row->payment_id);?></td>
                      <td class="font-w600"><?php  echo htmlentities($row->added_on);?></td>
