...
if(isset($_POST['submit2'])) { // Assuming 'submit2' is the name of your submit button
    ...
    $targetDirectory = "../img/venue-gallery/"; // Directory to store the uploaded files
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO tblvenue (vimgpath) VALUES (:imgpath)";
...
?>
<div class="card-body">
  <h4 class="card-title">Add venue Form </h4>
